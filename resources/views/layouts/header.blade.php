                ...
                <div class="main-menu">
                    <div class="nav">
                        <ul>
                            ...
                            <li class="nav-item {{ Helper::check_active(['coupon_page']) }}"><a
                                    href="{{ route('coupon_page') }}" title="{{ __('Mã giảm giá') }}">
                            ...
                            <li class="nav-item {{ Helper::check_active(['posts_page', 'post_page']) }}"><a
                                    href="{{ route('posts_page') }}" title="{{ __('Tin Tức') }}">
                                        ...
                                        <ul class="dropdown-menu">
                                            @if (Auth::user()->admin)
                                                <li><a href="{{ route('admin.dashboard') }}"><i
                                                            class="fas fa-tachometer-alt"></i> Quản Lý Website</a></li>
                                            @else
                                                <li class="{{ Helper::check_active(['orders_page', 'order_page']) }}">
                                                    <a href="{{ route('orders_page') }}"><i
                                                            class="fas fa-clipboard-list"></i> Quản Lý Đơn Hàng</a></li>
            ...
            <ul>
                ...
                @if (Auth::check() && !Auth::user()->admin)
                    <li class="mb-nav-item {{ Helper::check_active(['orders_page', 'order_page']) }}"><a
                            href="{{ route('orders_page') }}"><span class="fas fa-clipboard-list"></span> Đơn
                            Hàng</a></li>
                @endif
            </ul>
        </div>
        ...
        <div class="mobile-support">
            ...
            <div class="info-support">
                <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: +84 967 999 999"
                    title="(+84) 967 999 999">(+84) 967 999 999</a>
            </div>
            <div class="info-support">
