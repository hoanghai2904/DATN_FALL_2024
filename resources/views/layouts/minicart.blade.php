        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px"
            ...
            <g>
                <circle cx="154.112" cy="377.684" r="52.736" data-original="#000000" class="active-path"
                    data-old_color="#Ffffff" fill="#FFFFFF"></circle>
                <path
                    ...
                    data-original="#000000" class="active-path" data-old_color="#F8F8F8" fill="#FFFFFF"></path>
                <path
                                ...
                                <div class="product-details-bottom">
                                    ...
                                    <div class="quantity-select">
                                        <input class="variantID" type="hidden" name="variantId"
                                            value="{{ $key }}">
                                        <button onclick="minus({{ $key }});"
                                            class="reduced items-count btn-minus" type="button">–</button>
                                        <input type="text" disabled="" maxlength="3" min="1"
                                            max="{{ $item['item']->quantity }}"
                                            onchange="if(this.value == 0)this.value = 1;"
                                            class="input-text number-sidebar qty{{ $key }}"
                                            id="qty{{ $key }}" name="Lines" size="4"
                                            value="{{ $item['qty'] }}" data-url="{{ route('update_minicart') }}">
                                        <button onclick="plus({{ $key }});"
