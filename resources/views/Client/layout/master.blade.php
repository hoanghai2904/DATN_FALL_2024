...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/vendor/ionicons.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/vendor/simple-line-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/vendor/jquery-ui.min.css') }}">


    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/vendor/vendor.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/plugins/plugins.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/plugins/venobox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/client/assets/css/plugins/jquery.lineProgressbar.css') }}">
    ...
    <script src="{{ asset('theme/client/assets/js/vendor/vendor.min.js') }}"></script>
    <script src="{{ asset('theme/client/assets/js/plugins/plugins.min.js') }}"></script>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                            ...
                            <div class="header-logo">
                                <div class="logo">
                                    <a href="index.html"><img src="assets/images/logo/logo_black.png"
                                            alt=""></a>
                                </div>
                            </div>
                            <!-- End Header Logo -->
    ...
    <script src="{{ asset('theme/client/assets/js/vendor/jquery-ui.min.js') }}"></script>

    <!--Plugins JS-->
    <script src="{{ asset('theme/client/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('theme/client/assets/js/plugins/material-scrolltop.js') }}"></script>
    ...
    <script src="{{ asset('theme/client/assets/js/plugins/jquery.waypoints.js') }}"></script>
    <script src="{{ asset('theme/client/assets/js/plugins/jquery.lineProgressbar.js') }}"></script>
    <script src="{{ asset('theme/client/assets/js/plugins/aos.min.js') }}"></script>
    <script src="{{ asset('theme/client/assets/js/plugins/jquery.instagramFeed.j') }}s"></script>
