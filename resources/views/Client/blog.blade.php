                                        ...
                                        <div class="col-xl-7 col-md-6">
                                            <div class="content">
                                                <ul class="post-meta">
                                                   ...
                                                   <li>ON : <a href="#" class="date">{{ $item->created_at->format('Y-m') }}-{{ \Illuminate\Support\Carbon::parse($item->created_at)->locale('vi')->dayName }}</a></li>
                                                </ul>
                                                <hr>
                                                <h6>
                                                    <a href="blog-single-sidebar-left.html">{{ $item->title }}</a>
                                                </h6>                                                
