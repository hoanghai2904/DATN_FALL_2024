                 ...
                 <div class="row mb-n6">
                     ...
                     <div class="col-lg-6 col-12 mb-6">
                         ...
                         <div class="banner-single-item banner-style-1 banner-animation img-responsive" data-aos="fade-up"
                             data-aos-delay="0">
                             <div class="image">
                                 <img src="{{ asset('assets') }}/images/banner/banner-style-1-img-1.jpg" alt="">
                             </div>
                             <div class="content">
                         ...
                         <div class="row mb-n6">
                             ...
                             <div class="col-lg-6 col-sm-6 mb-6">
                                 <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                     ...
                                     <div class="image">
                                         <img src="{{ asset('assets') }}/images/banner/banner-style-2-img-1.jpg"
                                             alt="">
                                     </div>
                                     <div class="content">
                             ...
                             <div class="col-lg-6 col-sm-6 mb-6">
                                 <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                     ...
                                     <div class="image">
                                         <img src="{{ asset('assets') }}/images/banner/banner-style-2-img-2.jpg"
                                             alt="">
                                     </div>
                                     <div class="content">
                             ...
                             <div class="col-lg-6 col-sm-6 mb-6">
                                 <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                     data-aos="fade-up" data-aos-delay="0">
                                     <div class="image">
                                         <img src="{{ asset('assets') }}/images/banner/banner-style-2-img-3.jpg"
                                             alt="">
                                     </div>
                                     <div class="content">
                             ...
                             <div class="col-lg-6 col-sm-6 mb-6">
                                 <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                     data-aos="fade-up" data-aos-delay="200">
                                     <div class="image">
                                         <img src="{{ asset('assets') }}/images/banner/banner-style-2-img-4.jpg"
                                             alt="">
                                     </div>
                                     <div class="content">
                                         <h4>Interior <br>
                             ...
                             <div class="swiper-container product-default-slider-4grid-2row">
                                 ...
                                 <div class="swiper-wrapper">
                                     ...
                                     <div class="product-default-single-item product-color--golden swiper-slide">
                                         <div class="image-box">
                                             <a href="product-details-default.html" class="image-link">
                                                 <img src="{{ asset('assets') }}/images/product/default/home-1/default-7.jpg"
                                                     alt="">
                                                 <img src="{{ asset('assets') }}/images/product/default/home-1/default-8.jpg"
                                                     alt="">
                                             </a>
                                             <div class="action-link">
                                                 <div class="action-link-left">
                                     ...
                                     <div class="product-default-single-item product-color--golden swiper-slide">
                                         <div class="image-box">
                                             <a href="product-details-default.html" class="image-link">
                                                 <img src="{{ asset('assets') }}/images/product/default/home-1/default-9.jpg"
                                                     alt="">
                                     ...
                                     <div class="product-default-single-item product-color--golden swiper-slide">
                                         <div class="image-box">
                                             <a href="product-details-default.html" class="image-link">
                                                 <img src="{{ asset('assets') }}/images/product/default/home-1/default-11.jpg"
                                                     alt="">
                                                 <img src="{{ asset('assets') }}/images/product/default/home-1/default-3.jpg"
                                                     alt="">
                                             </a>
             ...
             <div class="row">
                 <div class="col-xl-8 offset-xl-2">
                     ...
                     <div class="banner-single-item banner-style-3 banner-animation img-responsive" data-aos="fade-up"
                         data-aos-delay="0">
                         <div class="image">
                             <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-3-img-1.jpg"
                                 alt="">
                         </div>
                         <div class="content">
     ...
     <div class="banner-section">
         <div class="banner-wrapper clearfix">
             ...
             <div class="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive"
                 data-aos="fade-up" data-aos-delay="0">
                 <div class="image">
                     <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-1.jpg"
                         alt="">
                 </div>
             ...
             <div class="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive"
                 data-aos="fade-up" data-aos-delay="200">
                 <div class="image">
                     <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-2.jpg"
                         alt="">
                 </div>
                 <a href="product-details-default.html" class="content">
                     <div class="inner">
             ...
             <div class="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive"
                 ...
                 <div class="image">
                     <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-3.jpg"
                         alt="">
                 </div>
                 <a href="product-details-default.html" class="content">
                     <div class="inner">
             ...
             <div class="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive"
                 ...
                 <div class="image">
                     <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-4.jpg"
                         alt="">
                 </div>
                 <a href="product-details-default.html" class="content">
                     <div class="inner">
                             ...
                             <div id="instagramFeed" class="instagram-grid clearfix">
                                 <a href="https://www.instagram.com/p/CCFOZKDDS6S/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-1.jpg"
                                         alt=""></a>
                                 <a href="https://www.instagram.com/p/CCFOYDNjWF5/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-2.jpg"
                                         alt=""></a>
                                 <a href="https://www.instagram.com/p/CCFOXH6D-zQ/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-3.jpg"
                                         alt=""></a>
                                 <a href="https://www.instagram.com/p/CCFOVcrDDOo/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-4.jpg"
                                         alt=""></a>
                                 <a href="https://www.instagram.com/p/CCFOUajjABP/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-5.jpg"
                                         alt=""></a>
                                 <a href="https://www.instagram.com/p/CCFOS2MDmjj/" target="_blank"
                                     class="instagram-image-link float-left banner-animation"><img
                                         src="{{ asset('assets') }}/images/instagram/instagram-6.jpg"
                                         alt=""></a>
                             </div>
