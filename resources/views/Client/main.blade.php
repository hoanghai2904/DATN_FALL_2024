                        ...
                        <div class="swiper-container company-logo-slider">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img  class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-1.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-2.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-3.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-4.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-5.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-6.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-7.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                                <!-- Start Company Logo Single Item -->
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid" src="{{ asset('assets') }}/images/company-logo/company-logo-8.png" alt=""></div>
                                </div>
                                <!-- End Company Logo Single Item -->
                            </div>
                        </div>
                        ...
                        <div class="swiper-container product-default-slider-4grid-1row">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-9.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-10.jpg" alt="">
                                        </a>
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-11.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-3.jpg" alt="">
                                        </a>
                                        <div class="action-link">
                                            <div class="action-link-left">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-5.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-7.jpg" alt="">
                                        </a>
                                        <div class="action-link">
                                            <div class="action-link-left">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-6.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-9.jpg" alt="">
                                        </a>
                                        <div class="action-link">
                                            <div class="action-link-left">
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            ...
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-2.jpg" alt="">
                                        </a>
                                        <div class="tag">
                                            <span>sale</span>
                                        </div>
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-3.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-4.jpg" alt="">
                                        </a>
                                        <div class="tag">
                                            <span>sale</span>
                                        </div>
                                ...
                                <div class="product-default-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-7.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-8.jpg" alt="">
                                        </a>
                                        <div class="action-link">
                                            <div class="action-link-left">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                ...
                <div class="banner-single-item banner-style-6 banner-animation img-responsive"  data-aos="fade-up"  data-aos-delay="0">
                    ...
                    <div class="content">
                        ...
                        <h2 class="title">Herbivore Botanicals
                            Basic Collection</h2>
                        <p>On a mission to create all-natural skin care that delivers tangible results, Herbivore ensures every ingredient within their formulas has a specific purpose, resulting in highly active.</p>
                        <a href="product-details-default.html" class="btn btn-lg btn-outline-green icon-space-left"><span class="d-flex align-items-center">Browse <i class="ion-ios-arrow-thin-right"></i></span></a>
                    </div>
                </div> 
                <!-- End Banner Single Item -->
            </div>
...
<div class="banner-section section-top-gap-100">
    <div class="banner-wrapper clearfix">
        ...
        <div class="banner-single-item banner-style-4 banner-animation banner-color--green float-left"  data-aos="fade-up"  data-aos-delay="0">
            <div class="image">
                <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-5.jpg" alt="">
            </div>
        ...
        <div class="banner-single-item banner-style-4 banner-animation banner-color--green float-left"  data-aos="fade-up"  data-aos-delay="200">
            <div class="image">
                <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-6.jpg" alt="">
            </div>
            <a href="product-details-default.html" class="content">
                <div class="inner">
        ...
        <div class="banner-single-item banner-style-4 banner-animation banner-color--green float-left"  data-aos="fade-up"  data-aos-delay="400">
            <div class="image">
                <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-7.jpg" alt="">
            </div>
            <a href="product-details-default.html" class="content">
                <div class="inner">
        ...
        <div class="banner-single-item banner-style-4 banner-animation banner-color--green float-left"  data-aos="fade-up"  data-aos-delay="600">
            <div class="image">
                <img class="img-fluid" src="{{ asset('assets') }}/images/banner/banner-style-4-img-8.jpg" alt="">
            </div>
            <a href="product-details-default.html" class="content">
                <div class="inner">
                    <h4>Easy chairs</h4>
                        ...
                        <div class="swiper-container product-listview-slider-4grid-3rows">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Consequuntur magni</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Pellentesque posuere</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Phasellus vel hendreri</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-11.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-12.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Cras neque metus</a></h6>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-13.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-14.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Officiis debitis varius</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-15.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-16.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Ornare sed consequat</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    <div class="image-box">
                                        <a href="product-details-default.html" class="image-link">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-17.jpg" alt="">
                                            <img src="{{ asset('assets') }}/images/product/default/home-2/default-18.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Convallis quam sit</a></h6>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Nostrum exercitation</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-listview-single-item product-color--green swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="product-details-default.html">Laudantium enim fringi</a></h6>
                                        <ul class="review-star">
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            <li class="fill"><i class="ion-android-star"></i></li>
                        ...
                        <div class="image">
                            ...
                            <div class="content">
                                <div class="text">
                                    ...
                                    <a href="product-details-default.html" class="btn btn-lg btn-green icon-space-left"><span class="d-flex align-items-center">Shop Now <i class="ion-ios-arrow-thin-right"></i></span></a>
                                </div>
                            </div>
                        </div>
