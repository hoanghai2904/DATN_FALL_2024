                                    ...
                                    <h5 class="mb-0">
                                        ...
                                        @if ((float) $product->price_sale > 0)
                                            <div class="d-flex align-items-center mx-2">
                                                ...
                                                <span class="badge bg-black text-danger me-2">
                                                    -{{ $salePer }}%
                                                </span>

                                                <!-- Sale Price -->
                                                <div data-order="{{ $product->price_sale }}"
                                                    class="fw-bold text-danger" style="margin-right: 5px;color: red!important;">
                        ...
                        <div class="product-details-variable">
                            ...
                            <div class="variable-single-item">
                                <div class="product-stock"> <span class="product-stock-in"><i
                                            class="ion-checkmark-circled"></i></span> {{ $product->qty }} CÒN HÀNG</div>
                            </div>
                            <!-- Product Variable Single Item -->
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    <div class="d-flex">
                                        <button class="btn btn-outline-secondary" id="decrement"
                                            type="button">-</button>
                                        <input type="number" class="text-center form-control" id="qty" name="qty"
                                            value="1" min="1">
                                        <button class="btn btn-outline-secondary" id="increment"
                                            type="button">+</button>
                                    </div>
                                </div>
                                <button class="btn btn-dark " data-bs-toggle="modal" data-bs-target="#modalAddcart">Thêm vào giỏ</button>
                            </div>
                                            ...
                                            <li class="comment-list">
                                                <div class="comment-wrapper">
                                                    <div class="comment-img">
                                                        <img src="{{ $comment->user->cover ? asset('storage/' .$comment->user->cover) : asset('theme/admin/assets/images/users/user-dummy-img.jpg') }}" alt="">
                                                    </div>
                                                    <div class="comment-content">
                                                        <div class="comment-content-top">
                                                            <div class="comment-content-left">
                                                                <h6 class="comment-name">{{ $comment->user->full_name}}</h6>
                                                                <ul class="review-star">
                    ...
                    <div class="col-12">
                        <div class="section-content-gap">
                            <div class="secton-content">
                                <h3 class="section-title">Sản phẩm liên quan
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="{{ route('product-detail',$item->slug) }}" class="image-link">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="{{ route('product-detail',$item->slug) }}">{{ $item->name }}</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
