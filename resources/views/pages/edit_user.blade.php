        ...
        <section class="section-user">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-9">
                        <div class="user">
                            <form class="form-user" action="{{ route('save_user') }}" method="POST" accept-charset="utf-8"
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-4">
                                        <div class="upload-avatar">
                                            <div title="Avatar Preview" class="avatar-preview"
                                                style="background-image: url('{{ Helper::get_image_avatar_url($data['user']->avatar_image) }}'); padding-top: 100%;">
                                            </div>
                                            <label for="upload" title="Upload Avatar"><i class="fas fa-folder-open"></i>
                                                Upload Avatar</label>
                                    ...
                                    <div class="col-md-9 col-sm-8 col-xs-8">
                                        ...
                                        <div class="action-edit">
                                            <button type="submit" class="btn btn-default" title="Lưu Thay Đổi">Lưu Thay
                                                Đổi</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#upload").change(function() {
                $('.site-user .upload-avatar .avatar-preview').css('background-image', 'url("' +
                    getImageURL(this) + '")');
            });
