                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4">
                                    <div class="user-avatar">
                                        <img src="{{ Helper::get_image_avatar_url($data['user']->avatar_image) }}"
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <div class="action-edit">
                                        <a href="{{ route('edit_user') }}" class="btn btn-default"
                                            title="Thay đổi thông tin cá nhân">Thay Đổi Thông Tin</a>
                                    </div>
                                </div>
                            </div>
                        </div>
