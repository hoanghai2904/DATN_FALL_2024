                                    ...
                                    <div class="item product-{{ $key }}">
                                        ...
                                        <div class="info-product">
                                            ...
                                            <div class="quantity-block">
                                                <div class="input-group-btn">
                                                    ...
                                                    <input type="text" onchange="if(this.value == 0) this.value=1;"
                                                        ...
                                                        value="{{ $item['qty'] }}" data-url="{{ route('update_cart') }}">
                                            ...
                                            <div class="remove-item">
                                                <a href="javascript:;" onclick="removeItem($(this));"
                                                    class="btn btn-link btn-item-delete remove-item-cart"
                                                    data-id="{{ $key }}" title="Xóa"
                                                    data-id="{{ $key }}" data-url="{{ route('remove_cart') }}"><i
                        ...
                        <div class="col-md-4">
                            <div class="total-price">
                                ...
                                <div class="btn-action">
                                    <button title="Thanh Toán Ngay" data-url="{{ route('show_checkout') }}">Thanh Toán
                                        Ngay</button>
                                    <a href="{{ route('products_page') }}" class="btn-btn-default"
