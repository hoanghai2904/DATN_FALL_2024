                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="color-product">
                                        @php
                                            $first_product = $data['product_details']->first(); // Lấy sản phẩm đầu tiên
                                            $detail = $first_product['details']->first(); // Lấy chi tiết sản phẩm đầu tiên
                                            $variants = $detail['variants']; // Lấy các biến thể
                                        @endphp
                                ...
                                <div class="tab-content">
                                    <div id="description" class="tab-pane fade in active">
                                        <div class="content-description">
                                            @if ($data['product']->information_details)
                                                    ...
                                                    <div class="rating-content">
                                                        ...
                                                        <div class="rating-form">
                                                            <form action="{{ route('add_vote') }}" method="POST"
                                                                ...
                                                                <button type="submit" class="btn btn-default">Gửi Đánh
                                                                    Giá</button>
                                                            </form>
                                                        </div>
                                                    </div>
