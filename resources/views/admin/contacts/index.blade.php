                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="status_contacts" class="form-control">
                                            ...
                                            <option value="Chưa phản hồi"
                                                {{ request('status_contacts') == 'Chưa phản hồi' ? 'selected' : '' }}>
                                                Chưa phản hồi</option>
                                            <option value="Đã phản hồi"
                                                {{ request('status_contacts') == 'Đã phản hồi' ? 'selected' : '' }}>
                                                Đã phản hồi</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($contacts as $contact)
                                        <tr>
                                            ...
                                            <td class="name text-center">{{ $contact->name }}</td>
                                            <td class="email">{{ $contact->email }}</td>
                                            <td class="phone">{{ $contact->phone }}</td>
                                            <td class="created_at">
                                                {{ \Carbon\Carbon::parse($contact->created_at)->format('d/m/Y') }}
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="messageModalLabel{{ $contact->id }}">Liên Hệ</h5>
                                            ...
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item mt-1">
                                                        <i class="fas fa-eye message-icon fs-16 "
