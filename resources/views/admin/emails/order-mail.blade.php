...
<body>
    ...
    <table border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td>{{ number_format($order->orderDetails->sum(function ($detail) {return $detail->price * $detail->quantity;}),0,',','.') }}
                đ</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ number_format($order->orderDetails->sum(function ($detail) {return $detail->price * $detail->quantity;}) +$order->fee -$order->discount,0,',','.') }}
                đ</td>
        </tr>
    </table>
</body>
