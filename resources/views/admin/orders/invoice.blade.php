                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <h5 class="fs-14 mb-0">${{ number_format($order->total_price, 0, ',', '.') }}₫</h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($orderItems->sum(function($item) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-medium">{{ number_format(($orderItems->sum(function($item) {
                                        return $item->product_price_sale ? $item->product_price_sale * $item->qty : $item->product_price * $item->qty;
