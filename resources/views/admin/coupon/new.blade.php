...
<form id="coupon-form" action="{{ route('admin.coupon.save') }}" method="POST" accept-charset="utf-8">
  @csrf
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="code" class="form-control" id="code" placeholder="Mã" value="{{ old('code') }}" autocomplete="off" required>
            @error('code')
              <span class="text-red">{{ $message }}</span>
            @enderror
          </div>
