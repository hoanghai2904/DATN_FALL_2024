                        ...
                        <div class="col-md-12">
                            <div class="box">
                                    ...
                                    <div id="print">
                                        <div class="box box-default box-chart">
                                            <div class="box-header with-border text-center">
                                                <h3 class="box-title">Biểu Đồ Kinh Doanh Tháng
                                                    {{ date('m') . ' Năm ' . date('Y') }}</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 col-xs-3">
                                                        <div class="description-block border-right description-order">
                                                            <h5 class="description-header">{{ $data['count_orders'] }}
                                                            </h5>
                                                    ...
                                                    <div class="col-sm-3 col-xs-3">
                                                        <div class="description-block border-right description-product">
                                                            <h5 class="description-header">{{ $data['count_products'] }}
                                                            </h5>
                                                    ...
                                                    <div class="col-sm-3 col-xs-3">
                                                        <div class="description-block border-right description-revenue">
                                                            <h5 class="description-header"><span
                                                                    style="color: #f30;">{{ number_format($data['total_revenue'], 0, ',', '.') . ' VNĐ' }}</span>
                                                            </h5>
                                                    ...
                                                    <div class="col-sm-3 col-xs-3">
                                                        <div class="description-block description-profit">
                                                            <h5 class="description-header"><span
                                                                    style="color: #f30;">{{ number_format($data['total_profit'], 0, ',', '.') . ' VNĐ' }}</span>
                                                            </h5>
                                        ...
                                        <div class="box box-default box-table">
                                            <div class="box-header with-border text-center">
                                                <h3 class="box-title">Danh Sách Sản Phẩm Xuất Kho Tháng
                                                    {{ date('m') . ' Năm ' . date('Y') }}</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th style="text-align: center; vertical-align: middle;">STT
                                                                </th>
                                                                ...
                                                                <th style="text-align: center; vertical-align: middle;">Số
                                                                    Lượng</th>
                                                            ...
                                                            @foreach ($data['order_details'] as $key => $order_detail)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: middle;">
                                                                        {{ '#' . $order_detail->product_detail->product->sku_code }}
                                                                    </td>
                                                                    <td style="vertical-align: middle;">
                                                                        {{ $order_detail->product_detail->product->name }}
                                                                    </td>
                                                                    <td style="vertical-align: middle;">
                                                                        {{ $order_detail->product_detail->color }}</td>
                                                                    <td style="vertical-align: middle;">
                                                                        {{ '#' . $order_detail->order->order_code }}</td>
                                                                    <td style="vertical-align: middle;">
                                                                        {{ date_format($order_detail->created_at, 'd/m/Y') }}
                                                                    </td>
                                                                    <td
                                                                        style="text-align: center; vertical-align: middle;">
                                                                        {{ $order_detail->quantity }}</td>
                                                                    <td style="vertical-align: middle;"><span
                                                                            style="color: #f30;">{{ number_format($order_detail->product_detail->import_price, 0, ',', '.') }}
                                                                            VNĐ</span></td>
                                                                    <td style="vertical-align: middle;"><span
                                                                            style="color: #f30;">{{ number_format($order_detail->price, 0, ',', '.') }}
                                                                            VNĐ</span></td>
                                                                    <td style="vertical-align: middle;"><span
                                                                            style="color: #f30;">{{ number_format($order_detail->price * $order_detail->quantity, 0, ',', '.') }}
                                                                            VNĐ</span></td>
                                                                    <td style="vertical-align: middle;"><span
                                                                            style="color: #f30;">{{ number_format($order_detail->quantity * ($order_detail->price - $order_detail->product_detail->import_price), 0, ',', '.') }}
                                                                            VNĐ</span></td>
                                                                </tr>
                                                            @endforeach
                                                            <tr>
                                                                <td colspan="11" style="text-align: right;">
                                                                    <i style="margin-right: 10px;">*Tổng Doanh Thu = <span
                                                                            style="color: #f30;">{{ number_format($price, 0, ',', '.') }}
                                                                            VNĐ</span></i>
                                                                    <i>*Tổng Lợi Nhuận = <span
                                                                            style="color: #f30;">{{ number_format($profit, 0, ',', '.') }}
                                                                            VNĐ</span></i>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <button class="btn btn-success btn-print pull-right"><i
                                                    class="fa fa-print"></i> In Báo Cáo</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-footer -->
