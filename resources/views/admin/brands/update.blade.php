                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$brands->name}}" placeholder="Nhập tên thương hiệu" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label" for="meta-keywords-input">Đại diện thương hiệu</label>
                                <input type="text" class="form-control" name="slug" value="{{$brands->slug}}" placeholder="Nhập đại diện thương hiệu"  >
                            </div>
                        </div>
                    </div>
                    {{-- <div>
