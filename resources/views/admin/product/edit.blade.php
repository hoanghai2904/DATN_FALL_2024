...
@section('content')
    ...
    <form id="productForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST"
                                ...
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <a href="javascript:void(0);" data-id="{{ $promotion->id }}"
                                            ...
                                            data-url="{{ route('admin.product.delete_promotion') }}"
                                            style="color: #f30;">
                ...
                <div id="product-details">
                    @if ($product->product_details->isNotEmpty())
                        @foreach ($product->product_details as $product_detail)
                            <div class="box field-group box-solid box-default collapsed-box" style="margin-bottom: 5px;">
                                <div class="box-header">
                                    <h3 class="box-title">
                                ...
                                <div class="box-body" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="color_{{ $product_detail->id }}">Loại Sản Phẩm<span
                                                        class="text-red">*</span></label>
                                                <input type="text"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    name="old_product_details[{{ $product_detail->id }}][size]"
                                                    class="form-control color" id="size_{{ $product_detail->id }}"
                                                    placeholder="Size" autocomplete="off"
                                                    value="{{ $product_detail->size }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="quantity_{{ $product_detail->id }}">Số Lượng <span
                                                        class="text-red">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="import_price_{{ $product_detail->id }}">Giá Nhập (VNĐ) <span
                                                        class="text-red">*</span></label>
                                                <input type="text"
                                                    name="old_product_details[{{ $product_detail->id }}][import_price]"
                                                    class="form-control currency"
                                                    id="import_price_{{ $product_detail->id }}" placeholder="Giá nhập"
                                                    required autocomplete="off"
                                                    value="{{ $product_detail->import_price }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="sale_price_{{ $product_detail->id }}">Giá Bán (VNĐ) <span
                                                        class="text-red">*</span></label>
                                                <input type="text"
                                                    ...
                                                    required autocomplete="off"
                                                    value="{{ $product_detail->sale_price }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="promotion_price_{{ $product_detail->id }}">Giá Khuyến Mại
                                                    (VNĐ)
                                                </label>
                                                <input type="text"
    ...
    <script>
            ...
            $("#upload").change(function(event) {
                ...
                if (target.value.length == 0) {
                    $('.upload-image .image-preview').css('background-image',
                        'url("{{ Helper::get_image_product_url($product->image) }}")');
                } else {
        ...
        $(function() {
            $("#product-promotions").repeatable({
                ...
                afterAdd: function() {
                    ...
                    $('#product-promotions>.field-group:not(:last-child)>.box,#product-promotions>.box')
                        .boxWidget('collapse');
            ...
            $("#product-details").repeatable({
                ...
                afterAdd: function() {
                    ...
                    $('#product-details>.field-group:not(:last-child)>.box,#product-details>.box')
                        .boxWidget('collapse');
                    ...
                    $('input.color').on('keyup', function() {
                        ...
                        $(this).closest('.box').find('.box-header .box-title span.name').text(
                            name);
                        $(this).closest('.box').find('.box-header .box-title span.color').text(
                            val);
                    });
                },
            ...
            var validator = $("#productForm . field-group ").validate({
        ...
        $(document).ready(function() {
            ...
            $(".remove-product-detail").click(function() {
                ...
                var url = $(this).attr('data-url');
                console.log("length:",$('#product-details .field-group').length);
