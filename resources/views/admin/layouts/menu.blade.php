        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="#" aria-controls="sidebarDashboards">
                    <i class="ri-folder-3-line"></i> <span data-key="t-dashboards">Quản lý danh mục</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="#product" data-bs-toggle="collapse" role="button"
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('admin.banners.listBanner') }}" aria-controls="sidebarDashboards">
                    <i class="ri-image-line"></i> <span data-key="t-dashboards">Quản lý banner</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('admin.orders.index') }}" aria-controls="sidebarDashboards">
                    <i class="ri-file-list-line"></i> <span data-key="t-dashboards">Quản lý đơn hàng</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('admin.contacts.index') }}" aria-controls="sidebarDashboards">
                    <i class="ri-phone-line"></i> <span data-key="t-dashboards">Quản lý liên hệ</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="#sale" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarDashboards">
                    <i class="ri-price-tag-3-line"></i> <span data-key="t-dashboards">Quản lý khuyến mại</span>
                </a>
                <div class="collapse menu-dropdown" id="sale">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="#news" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarDashboards">
                    <i class="ri-article-line"></i> <span data-key="t-dashboards">Bài viết</span>
                </a>
                <div class="collapse menu-dropdown" id="news">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="#coment" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarDashboards">
                    <i class="ri-chat-3-line"></i> <span data-key="t-dashboards">Quản lý bình luận</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="#review" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarDashboards">
                    <i class="ri-star-line"></i> <span data-key="t-dashboards">Quản lý đánh giá</span>
                </a>
                <div class="collapse menu-dropdown" id="review">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
