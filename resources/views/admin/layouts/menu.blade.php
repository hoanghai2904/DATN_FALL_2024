                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <a href="{{ route('admin.categories.index') }}" class="nav-link" data-key="t-analytics">
                                <i class="ri-folder-3-line"></i> Quản lý danh mục
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.products.index') }}" class="nav-link" data-key="t-analytics">
                                <i class="ri-shopping-bag-3-line"></i> Quản lý sản phẩm
                            </a>
                        </li>
                    
                        <li class="nav-item">
                            <a href="{{ route('admin.orders.index') }}" class="nav-link" data-key="t-analytics">
                                <i class="ri-file-list-3-line"></i> Quản lý đơn hàng
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.vouchers.index') }}" class="nav-link" data-key="t-analytics">
                                <i class="ri-price-tag-3-line"></i> Quản lý khuyến mãi
                            </a>
                        </li>
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.brands.index') }}" class="nav-link" data-key="t-ecommerce">
                                    <i class="ri-award-line"></i> Thương hiệu
                                </a>
                            </li>
                            <li class="nav-item">
                            <a href="{{ route('admin.banners.listBanner') }}" class="nav-link" data-key="t-analytics">
                                <i class="ri-image-line"></i> Quản lý banner
                            </a>
                        </li>
