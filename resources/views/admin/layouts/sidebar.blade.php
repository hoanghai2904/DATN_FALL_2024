<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="{{ Helper::check_active(['admin.vouchers.index', 'admin.vouchers.create', 'admin.vouchers.edit']) }}"><a href="{{ route('admin.vouchers.index') }}"><i class="fa-solid fa-ticket" aria-hidden="true"></i> <span>Quản Lý vouchers</span></a></li>
