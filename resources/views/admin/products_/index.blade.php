        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <a href="{{ route('admin.products_.create') }}" class="btn btn-success">Thêm mới</a>
                </div>
                <!-- end card header -->

                <div class="card-body">
                    <form action="{{ route('admin.products_.index') }}" method="GET">
                        @csrf
                        <div class="row mb-5 ">
                            <div class="col-lg-3">
                                    ...
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.products_.edit', $product->id) }}" class="btn btn-sm btn-warning">Sửa</a>
                                                <a href="{{ route('admin.products_.destroy', $product->id) }}"
